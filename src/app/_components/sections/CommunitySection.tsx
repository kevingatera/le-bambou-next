...
export const CommunitySection = async () => {
  return (
    <section className="mx-auto max-w-[calc(100vw-4rem)] py-12">
      <div className="px-4 md:px-8 lg:px-16">
        ...
        <div className="w-auto flex-[0_auto]">
          <div className="w-layout-grid grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            <div className="bg-[#b9c5c4] rounded-lg flex flex-col justify-start overflow-hidden">
              ...
              <div className="flex flex-col justify-center pt-6 pb-6 px-12 gap-[1.2em]">
            ...
            <div className="bg-[#b9c5c4] rounded-lg flex flex-col justify-start overflow-hidden">
              ...
              <div className="flex flex-col justify-center pt-6 pb-[45px] px-12 gap-[1.2em]">
